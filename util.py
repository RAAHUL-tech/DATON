...
def write_csv(results, output_path):
    ...
    """
    fields = ['frame_nmr', 'car_id', 'x1_car_bbox', 'y1_car_bbox', 'x2_car_bbox', 'y2_car_bbox',
              'x1_license_plate_bbox', 'y1_license_plate_bbox', 'x2_license_plate_bbox',
              'y2_license_plate_bbox', 'license_number',
    ...
    with open(output_path, 'w') as f:
        ...
        for frame_nmr in results.keys():
            print("Frame_no:", results[frame_nmr])
            for car_id in results[frame_nmr].keys():
                print("Results are:", results[frame_nmr][car_id])
                if 'car' in results[frame_nmr][car_id].keys() and \
                   'license_plate' in results[frame_nmr][car_id].keys() and \
                   'text' in results[frame_nmr][car_id]['license_plate'].keys():
                    result = [frame_nmr, car_id, results[frame_nmr][car_id]['car']['bbox'][0],
